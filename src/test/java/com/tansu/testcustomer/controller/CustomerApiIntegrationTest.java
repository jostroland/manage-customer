...
//                LOCALHOST.concat(String.valueOf(port)).concat("/"), HttpMethod.GET, entity, new ParameterizedTypeReference<>(){});
//
//        //ResponseEntity<String> response = restTemplate.getForEntity(LOCALHOST.concat(String.valueOf(port)).concat("/") , String.class);
//
